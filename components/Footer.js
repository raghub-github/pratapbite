  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Footer Main Content */}
        <motion.div
          className="footer-content grid grid-cols-1 md:grid-cols-3 gap-8 mb-10"
          variants={containerVariants}
        >
          {/* Logo & Contact */}
          <motion.div className="footer-col flex flex-col items-center md:items-start" variants={fadeUpVariant}>
            <div className="footer-logo flex items-center gap-3 mb-4">
              <img
                ...
                className="footer-logo-img w-[45px] h-[45px] rounded-[10px] object-cover border-2 border-[#e63946] p-[2px] bg-white"
              />
              <div className="footer-logo-text flex flex-col">
                ...
                <div className="footer-logo-sub text-xs text-white/70 font-medium mt-0.5 tracking-wide">
          ...
          <motion.div className="footer-col flex flex-col items-center md:items-start" variants={fadeUpVariant}>
            ...
            <ul className="footer-links space-y-2">
              <li>
                <a href="#home" className="flex items-center gap-2 text-white/80 hover:text-white transition font-medium text-[0.95rem]">
                  <i className="fas fa-chevron-right text-[#e63946] w-[18px]"></i> Home
                </a>
              </li>
              <li>
                <a href="#features" className="flex items-center gap-2 text-white/80 hover:text-white transition font-medium text-[0.95rem]">
                  <i className="fas fa-chevron-right text-[#e63946] w-[18px]"></i> Features
                </a>
              </li>
              <li>
                <a href="#delivery" className="flex items-center gap-2 text-white/80 hover:text-white transition font-medium text-[0.95rem]">
                  <i className="fas fa-chevron-right text-[#e63946] w-[18px]"></i> Delivery
                </a>
              </li>
              <li>
                <a href="#why-choose-us" className="flex items-center gap-2 text-white/80 hover:text-white transition font-medium text-[0.95rem]">
                  <i className="fas fa-chevron-right text-[#e63946] w-[18px]"></i> Why Us
                </a>
              </li>
              <li>
                <a href="#contact" className="flex items-center gap-2 text-white/80 hover:text-white transition font-medium text-[0.95rem]">
                  <i className="fas fa-chevron-right text-[#e63946] w-[18px]"></i> Contact
                </a>
              </li>
            </ul>
          </motion.div>
        ...
        {/* Copyright */}
        <motion.div className="copyright border-t border-white/15 dark:border-transparent pt-8 text-center text-white/70 text-[0.9rem]" variants={fadeUpVariant}>
